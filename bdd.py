...
def main():
    ...
    while True:
        try:
            ...
            print('19. Buscar alumnos por edad o nombre')
            print('20. Buscar alumnos por edad y correo')
            print('21. Listar asignaturas excluyendo códigos')
            print('22. Buscar alumnos con RUT distinto')
